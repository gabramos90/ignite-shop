...
// quando eu migro para getstatics nao se tem mais acesso pois esse só roda quando o next cria uma versao statica daquela pagina //npm run build, ou seja se em algum momento essa página precisar de informações especíoficaas para cada usuáriop ela nao pode